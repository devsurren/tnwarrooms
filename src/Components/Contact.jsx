...
const Contact=()=>{
    return(
        <>
             <div className='  sm:w-600 sm:h-400 p-4 md:p-0 mx-auto flex flex-col justify-center align-center  font-black  '>
                     ...
                     <h4 className='font-roboto font-extrabold text-xl py-1'>contact@vesseltechnologies.com</h4>
                </div>
